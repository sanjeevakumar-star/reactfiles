...
const Trendyimages=()=>{
    ...
    <div className="row">
   <div className="col md-6 bg-succs">
...
<img  className="trendyimg1"src="https://d-themes.com/react/molla/demo-2/assets/images/products/shop/product-1-2.jpg"/>
<img  className="trendyimg1" src ="https://d-themes.com/react/molla/demo-2/assets/images/products/shop/product-1-1.jpg"/>

</div>
  <div className="col md-6 bg-primar"> 
