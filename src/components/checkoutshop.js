...
function Checkoutshop(){
    ...
    return(
        <div className="container">
          ...
          <div className="col-md-8">
            <b>  <h5 className="billingdetails">Billing details</h5> </b>
            <form>
    ...
    <div class="form-check">
      ...
      <input type="email" class="form-control" id="inputEmail4" placeholder="Lastname"/>
  <div class="form-row">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="inputAddress2" placeholder="Phone_Number"/>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
